...
var SearchResults = function (_React$Component) {
  ...
  SearchResults.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      'div',
      null,
      this.props.results.length > 0 && !this.props.resultComponent && _react2.default.createElement(
        _reactBootstrap.Col,
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.results.map(function (result) {
            return _react2.default.createElement(_this2.state.resultComponent, {
              key: result.uri,
              result: result,
              detailPath: _this2.props.detailPath || '/detail'
            });
          }),
          !this.props.isSearchPending && this.props.results.length === 0 && _react2.default.createElement(this.props.noResults, null)
        )
      )
    );
  };
